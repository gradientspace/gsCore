...
namespace gs
{
    ...
    public class SnapDrawPrimitivesToolBuilder : IToolBuilder
    {
        ...
        public ITool Build(FScene scene, List<SceneObject> targets) {
            return new SnapDrawPrimitivesTool(scene);
        }
    }
    ...
    public class SnapDrawPrimitivesTool : ITool
    {
        ...
        public SnapDrawPrimitivesTool(FScene scene)
        {
            ...
            behaviors.Add(
                new SnapDrawPrimitivesTool_MouseBehavior(scene.Context) { Priority = 5 } );
            behaviors.Add(
                new SnapDrawPrimitivesTool_SpatialDeviceBehavior(scene.Context) { Priority = 5 });
    ...
    class SnapDrawPrimitivesTool_SpatialDeviceBehavior : StandardInputBehavior
    {
        FContext context;

        public SnapDrawPrimitivesTool_SpatialDeviceBehavior(FContext s)
        {
            context = s;
        }
        ...
        override public CaptureRequest WantsCapture(InputState input)
        {
            if (input.bLeftTriggerPressed ^ input.bRightTriggerPressed) {
                ...
                if (tool != null && tool is SnapDrawPrimitivesTool) {
                    AnyRayHit rayHit;
        ...
        override public Capture BeginCapture(InputState input, CaptureSide eSide)
        {
            ...
            SnapDrawPrimitivesTool tool = context.ToolManager.GetActiveTool((int)eSide) as SnapDrawPrimitivesTool;
        ...
        {
            SnapDrawPrimitivesTool tool = context.ToolManager.GetActiveTool((int)data.which) as SnapDrawPrimitivesTool;
    ...
    class SnapDrawPrimitivesTool_MouseBehavior : StandardInputBehavior
    {
        FContext context;

        public SnapDrawPrimitivesTool_MouseBehavior(FContext s)
        {
            context = s;
        }
        ...
        override public CaptureRequest WantsCapture(InputState input) {
            if ( context.ToolManager.ActiveRightTool == null || ! (context.ToolManager.ActiveRightTool is SnapDrawPrimitivesTool) )
                return CaptureRequest.Ignore;
